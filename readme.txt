...
|                                                                                                              |
|--------------------------------------------------------------------------------------------------------------|
| 2.1) TEMPLATE ELIF (LOOM/KLOOM) <- IMPORTANT!!:                                                              |
|                                                                                                              |
| elif key == 'name%of%the%key':                                                                               |
|	while key == 'name%of%the%key':                                                                        |
|		for char in chars:                                                                             |
|			st.stdout.write('\r'+'Initializing {name%of%the%key}...'+char)                         |
|			time.sleep(time)                                                                       |
|                       sys.stdout.flush()                                                                     |
|		os.system('cls')                                                                               |
|		template_loom()                                                                                |
|               print("Initialization of {name%of%they%key} - Process Completed!)                              |
|               break                                                                                          |
|--------------------------------------------------------------------------------------------------------------|
|                                                                                                              |
|	The TEMPLATE 2.1 was gonna be importante on the kLOOM new Keys function.  
